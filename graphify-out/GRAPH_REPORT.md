...
- `PlayerPacket` --inherits--> `PacketBaseInfo`  [EXTRACTED]
  ZeusGateway/src/test/java/org/vennv/zeusGateway/task/BatchSenderTest.java → ZeusProtocolJava/src/main/java/org/vennv/PacketBaseInfo.java
- `PlayerPacket` --inherits--> `PacketBaseInfo`  [EXTRACTED]
  ZeusGateway/src/test/java/org/vennv/zeusGateway/provider/PacketQueueTest.java → ZeusProtocolJava/src/main/java/org/vennv/PacketBaseInfo.java
- `CaptureFrameV3` --implements--> `PacketBase`  [EXTRACTED]
  ZeusProtocolJava/src/main/java/org/vennv/packets/CaptureFrameV3.java → ZeusProtocolJava/src/main/java/org/vennv/PacketBase.java
- `PacketPhysicsCaptureSample` --implements--> `PacketBase`  [EXTRACTED]
  ZeusProtocolJava/src/main/java/org/vennv/packets/PacketPhysicsCaptureSample.java → ZeusProtocolJava/src/main/java/org/vennv/PacketBase.java
...
Cohesion: 0.20
Nodes (9): Architecture, code:block1 (zeus_plugins/), code:java (import org.vennv.packets.PacketPlayerCustomFeature;), Custom Packets, Modules, Protocol Packets, Zeus Gateway, ZeusGateway Data Sources (+1 more)
...
Cohesion: 0.04
Nodes (44): artifact, artifactSha256, capabilityScenarioCommands, captureSeconds, command, configPath, deployedArtifact, dryRun (+36 more)
...
Cohesion: 0.17
Nodes (35): class_major_version(), load_manifest(), main(), missing_profile_packet_ids(), parse_pom(), pom_text(), print_results(), read_protocol_reference() (+27 more)

### Community 26 - "Community 26"
Cohesion: 0.06
Nodes (33): command, configPath, deployedGateway, deployedLab, durationSeconds, exitCode, failureLines, gate (+25 more)
...
Cohesion: 0.08
Nodes (26): args, bot, botOpts, buildEnvironment(), clearControls(), ffmpeg, fs, HOST (+18 more)
...
Cohesion: 0.06
Nodes (36): args, assert, bot, botOpts, chestBlock, cleanupPiston(), commands, commandSet() (+28 more)

### Community 39 - "Community 39"
Cohesion: 0.15
Nodes (26): capability_scenario_commands(), copy_artifact(), default_artifact(), default_evidence(), default_fabric_target(), default_gateway_target(), default_success_pattern(), display_path() (+18 more)

### Community 40 - "Community 40"
Cohesion: 0.08
Nodes (23): artifact, artifactSha256, command, deployedArtifact, dryRun, durationSeconds, exitCode, failurePatterns (+15 more)
...
Cohesion: 0.15
Nodes (20): activateNearby(), args, attackNearest(), bot, botOpts, clearControls(), completed, findNearbyBlock() (+12 more)
...
Cohesion: 0.23
Nodes (17): command_from_args(), copy_artifact(), default_artifact(), default_evidence(), default_fabric_target(), default_gateway_target(), default_success_pattern(), display_path() (+9 more)

### Community 68 - "Community 68"
Cohesion: 0.19
Nodes (6): Item, ByteArrayOutputStream, ByteBuffer, ItemStack, Override, String

### Community 69 - "Community 69"
Cohesion: 0.12
Nodes (15): code:java (PacketQueue.push(packet);), code:java (PacketEncode packet = PacketQueue.poll();), code:java (ByteArrayOutputStream out = new ByteArrayOutputStream();), code:java (DatagramPacket udp = new DatagramPacket(payload, payload.len), Implementing a Custom Collector, Packet Lifecycle, Step 1: Event Interception, Step 2: Data Extraction (+7 more)

### Community 70 - "Community 70"
Cohesion: 0.08
Nodes (23): Evidence Paths, paper-1.21.11 (ZeusGateway), paper-1.21.7 (ZeusGateway), paper-1.21.7 (ZeusGateway-modern), paper-26.2 (ZeusGateway), spigot-1.13.2 (ZeusGateway), spigot-1.13.2 (ZeusGateway-legacy), spigot-1.14.4 (ZeusGateway) (+15 more)

### Community 71 - "Community 71"
Cohesion: 0.18
Nodes (6): ItemStack, ByteArrayOutputStream, ByteBuffer, Deprecated, Override, String
...
Cohesion: 0.12
Nodes (15): author, dependencies, canvas, gl, mineflayer, prismarine-viewer, description, keywords (+7 more)
...
Cohesion: 0.17
Nodes (5): PacketPlayerClickWindow, ByteArrayOutputStream, ItemStack, Override, String
...
Cohesion: 0.19
Nodes (15): Armor, Armors, code:block41 (+0    1    u8      effect_id), code:block42 (+0    2    u16     item_name_length), code:block43 (+0    2    u16     item_id_length), code:block44 (+0    2    u16     armor_name_length), code:block45 (+0    1    u8      presence_flags (bit 0=helmet, 1=chestplat), code:block46 (+0    4    i32     dx) (+7 more)
...
Cohesion: 0.37
Nodes (12): as_list(), bool_value(), buildable_targets(), common_args(), core_args(), load_json(), main(), optional_string() (+4 more)
...
Cohesion: 0.27
Nodes (8): BasicCommand, Collection, CommandSourceStack, PaperZeusDebugCommand, Collection, Override, String, ZeusDebugCommand

### Community 114 - "Community 114"
Cohesion: 0.17
Nodes (11): BatchSender, code:block1 (PacketEncode.encode(ByteArrayOutputStream out)), code:block2 (while (true) {), Encoding Flow, Error Handling, Host Resolution, PacketQueue, Protocol (+3 more)
...
Cohesion: 0.18
Nodes (10): Byte, DiggingAction, PacketBlockFaceListener, Byte, Integer, Object, OrderedPlayerPacketDispatcher, Override (+2 more)

### Community 118 - "Community 118"
Cohesion: 0.14
Nodes (13): EmptyPacket, LegacyCollisionWindowProducerTest, AfterEach, ByteArrayOutputStream, CellSource, Center, List, Override (+5 more)
...
Cohesion: 0.31
Nodes (12): evidence_path(), gate_state(), load_verifier_module(), main(), marker(), parse_required_gates(), readiness(), render() (+4 more)
...
Cohesion: 0.20
Nodes (5): CustomFeatureCategory, PacketPlayerCustomFeature, ByteArrayOutputStream, Override, String

### Community 142 - "Community 142"
Cohesion: 0.15
Nodes (12): DamageCause Mapping Differences, Effect Type Resolution, Platform Differences, Surrounding Blocks Source, Teleport Detection, Teleport Detection (Fabric Only), Tick Polling Throttling, World State Source (+4 more)
...
Cohesion: 0.29
Nodes (5): PacketPlayerHeldItem, ByteArrayOutputStream, Item, Override, String
...
Cohesion: 0.29
Nodes (5): PacketPlayerArmorsEquipment, Armors, ByteArrayOutputStream, Override, String

### Community 152 - "Community 152"
Cohesion: 0.29
Nodes (5): PacketPlayerUseItem, ByteArrayOutputStream, Hand, Override, String

### Community 153 - "Community 153"
Cohesion: 0.22
Nodes (4): PacketPlayerVelocity, ByteArrayOutputStream, Override, String
...
Cohesion: 0.29
Nodes (5): PacketPlayerEffect, ByteArrayOutputStream, Effect, Override, String

### Community 157 - "Community 157"
Cohesion: 0.20
Nodes (9): code:block1 (Minecraft Server (Java)), Configuration, Data Flow, Modules, Purpose, Zeus Plugins -- Overview, ZeusFabric, ZeusGateway (+1 more)

### Community 158 - "Community 158"
Cohesion: 0.27
Nodes (6): PacketEntityDestroy, ByteArrayOutputStream, Integer, List, Override, String
...
Cohesion: 0.29
Nodes (5): PacketPlayerAttackEntity, ByteArrayOutputStream, EntityState, Override, String

### Community 163 - "Community 163"
Cohesion: 0.29
Nodes (5): PacketPlayerEntityInteraction, ByteArrayOutputStream, EntityState, Override, String

### Community 164 - "Community 164"
Cohesion: 0.29
Nodes (5): PacketPlayerAttackedByEntity, ByteArrayOutputStream, EntityState, Override, String
...
Cohesion: 0.29
Nodes (6): PacketHeldItemListener, OrderedPlayerPacketDispatcher, Override, PacketReceiveEvent, Player, ZeusGateway
...
Cohesion: 0.17
Nodes (6): Armors, Armor, ByteArrayOutputStream, ByteBuffer, Override, String
...
Cohesion: 0.29
Nodes (6): Binary Protocol Specification, Byte Order, code:block1 (Offset  Size   Type    Field), Common Header, DamageCause Values, EffectType Values
...
Cohesion: 0.18
Nodes (7): LongSupplier, CollisionGenerationAllocator, FileStore, Store, Override, Path, String

### Community 195 - "Community 195"
Cohesion: 0.07
Nodes (31): AutoCloseable, EventManager, Lane, Long, PacketListenerCommon, Lane, OrderedPlayerPacketDispatcher, OrderedWorldPacketDispatcher (+23 more)

### Community 196 - "Community 196"
Cohesion: 0.29
Nodes (5): PacketPlayerAttackedByPlayer, ByteArrayOutputStream, EntityState, Override, String

### Community 198 - "Community 198"
Cohesion: 0.33
Nodes (5): CustomFeatureCategory(), fromId(), toString(), Override, String

### Community 199 - "Community 199"
Cohesion: 0.33
Nodes (5): DamageCause(), fromValue(), toString(), Override, String

### Community 200 - "Community 200"
Cohesion: 0.33
Nodes (5): fromValue(), Hand(), toString(), Override, String

### Community 201 - "Community 201"
Cohesion: 0.33
Nodes (5): fromValue(), ServerBoundPlayerCommandActions(), toString(), Override, String

### Community 202 - "Community 202"
Cohesion: 0.29
Nodes (6): code:bash (python3 scripts/write_release_evidence.py), code:bash (python3 scripts/run_startup_smoke.py gateway \), code:bash (python3 scripts/run_startup_smoke.py fabric \), code:bash (python3 scripts/run_core_scenario_smoke.py gateway \), code:bash (python3 scripts/run_smoke_matrix.py \), Verification Evidence

### Community 203 - "Community 203"
Cohesion: 0.29
Nodes (6): dependencies, canvas, gl, prismarine-viewer, puppeteer, puppeteer-stream

### Community 206 - "Community 206"
Cohesion: 0.40
Nodes (3): PaperDebugCommandRegistrar, ZeusDebugCommand, ZeusGateway
...
Cohesion: 0.40
Nodes (5): labVerify, expectedStations, passed, startCommandBlocksFound, stationSignsFound

### Community 214 - "Community 214"
Cohesion: 0.40
Nodes (5): startupSeen, done, gateway, lab, paperVersion
...
Cohesion: 0.29
Nodes (5): PacketPlayerReleaseUseItem, ByteArrayOutputStream, Hand, Override, String
...
Cohesion: 0.40
Nodes (5): code:properties (proxy-host=0.0.0.0), code:yaml (proxy-ac:), Configuration, ZeusFabric (`config/zeusfabric.properties`), ZeusGateway (`plugins/ZeusGateway/config.yml`)
...
Cohesion: 0.29
Nodes (4): PacketPlayerCloseWindow, ByteArrayOutputStream, Override, String
...
Cohesion: 0.25
Nodes (7): active_policy_hash, audit_actor, audit_source, global_default_mode, per_server_overrides, schema_version, updated_at
